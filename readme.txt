...
* con\mIRCd.raws	 - Raw numeric replies. (It is recommended leaving this file alone.)
* conf\INFO.txt		 - Called when doing /INFO.
* misc\debugUser.mrc	 - A socket clone used for debugging.
* notes\*.txt		 - Contains some general information. (E.g. Reserved Modes)
...
7. Connect to the server via: /server localhost 6667
   ...
   If you wish to get other people to connect - depending on firewall/router rules - it'll be: /server your.ip 6667
