...
alias mIRCd.rehash {
  ...
  .mIRCd.load
  ; >-> Just reload everything via mIRCd.load. Next, we need to delete the removed items. We need to check four times.
  :processCleanup
...
alias mIRCd.load {
  ...
  var %this.sections = Server,Mechanics,Features
  tokenize 44 %this.sections
